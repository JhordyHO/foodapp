                         ...
                         <div class="row">
                             ...
                             <div class="col m5">
                                 <select name="id_category">
                                     <option value="0" disabled selected>Categoria Link</option>
                                     @foreach($category as $cat)
                                         @if($cat->admin == 'off')
                                             <option value="{{$cat->idCategory}}" data-icon="{{$cat->icon}}">{{$cat->nombre_categoria}}</option>
                                         @endif
                                     @endforeach
                                 </select>
                             </div>
                             <div class="col m1"><p style="font-size: 20px">/</p></div>
                             <div class="col m5">
                                 <input name="nombre_producto" id="nombre" placeholder="Nombre del producto" type="text" class="validate">
                             </div>
                               ...
                               <div class="col s6">
                                   <div class="row">
                                       <select name="id_category">
                                           ...
                                           @foreach($post as $pos)
                                               <option value="{{$pos->idPost}}">{{$pos->titulo}}</option>
                                           @endforeach
                                       </select>
